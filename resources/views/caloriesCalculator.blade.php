...
<script> function calc() {
    ...
    var d = (document.getElementById("d").innerHTML = (W / ((H * H) / 10000)).toFixed(2))
    ...
    document.getElementById("bmi_calc").value = d;
    // return d;
}

</script>
{{-- <script type="text/javascript">
  documnet.getElementById("navigation").onclick = function(){
...
<body>
  ...
  <main>
    ...
    <div class="card text-center border-warning-color-dark"
      style="max-width: 50rem; margin: auto; border: 5px solid green; width: 101%; margin-top: 30px; min-width: 20rem;">
      ...
      <!-- UwU -->
      <button id="B" type="submit" onclick="calc()" class="btn-amber cal">Calculate</button>
    </div>
    ...
    <div id="Final" class="card text-center"
      ...
      <tr>
          ...
          <td class="T" style="font-weight: bold;">BMI <p></p>
          </td>
          <td><div id="d" class="SS">&nbsp</div><div class="CD"></div></td>
    ...
    <form method="post" action="">
      @csrf
    <input class= "form-control" type="hidden" name="bmi" id ="bmi_calc" value="">
    <div id="" class="">&nbsp</div>
    <div id="" class="">&nbsp</div>
    <div id="" class="" style="font-weight: bold;">Click below to see our suggestions of exercise and food recipe for you.</div>
    <div id="" class="">&nbsp</div>
    <button type="submit" class="btn btn-secondary" >Suggestions</button>  
